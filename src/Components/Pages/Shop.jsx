...
function Shop() {
    ...
    const handleFilterSort = () => {
        ...
        if (filterSortOption === 'low') {
            filtered.sort((a, b) =>
                parseFloat(a.price.replace(' IQD', '').replace(',', '')) - parseFloat(b.price.replace(' IQD', '').replace(',', ''))
            );
        }

        if (filterSortOption === 'high') {
            filtered.sort((a, b) =>
                parseFloat(b.price.replace(' IQD', '').replace(',', '')) - parseFloat(a.price.replace(' IQD', '').replace(',', ''))
            );
        }
