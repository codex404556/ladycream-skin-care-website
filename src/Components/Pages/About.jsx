                ...
                <div className="team-row">
                    ...
                    <div className="team-member">
                        <div className="team-image-wrapper">
                            <img src={team1} alt="Ali" className="team-image" />
                    ...
                    <div className="team-member">
                        <div className="team-image-wrapper">
                            <img src={team2} alt="Ali" className="team-image" />
                            <div className="team-social">
                                <a href="#"><i className="ri-instagram-line"></i></a>
                                <a href="#"><i className="ri-twitter-line"></i></a>
                                <a href="#"><i className="ri-facebook-line"></i></a>
                    ...
                    <div className="team-member">
                        <div className="team-image-wrapper">
                            <img src={team3} alt="Ali" className="team-image" />
                            <div className="team-social">
                                <a href="#"><i className="ri-instagram-line"></i></a>
                                <a href="#"><i className="ri-twitter-line"></i></a>
                                <a href="#"><i className="ri-facebook-line"></i></a>
